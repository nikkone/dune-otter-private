        ...
        struct Task: public DUNE::Tasks::Periodic
        {
          ...
          void findFishPosition(const IMC::TBRFishTag &receiver1, const IMC::TBRFishTag &receiver2, const IMC::TBRFishTag &receiver3) {
            ...
            if(validCombination[0] || validCombination[1] || validCombination[2])
            {
              ...
              double depth = (validCombination[0]*(tagDepth(0,0) + tagDepth(1,0))/2 +
                              validCombination[1]*(tagDepth(1,0) + tagDepth(2,0))/2 +
                              validCombination[2]*(tagDepth(2,0) + tagDepth(0,0))/2)/
                             (validCombination[0] + validCombination[1] + validCombination[2]);

              m_xkf.update(receiverPositions, RDOA, depth, validCombination);
